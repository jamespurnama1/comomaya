<template>
  <section class="bg-beige-lighter h-min">
    <div class="max-w-[1920px] md:px-9 pt-10 md:py-0 lg:px-20 xl:px-36 lg:flex-row relative flex flex-col md:gap-8 justify-end mx-auto">
      <div class="lg:w-3/5 my-auto md:pt-16 px-9 lg:pl-20 xl:pl-36 flex flex-col items-end">
        <h3 class="text-stone-500 text-sm md:text-lg font-semibold tracking-widest text-right">
          GRANTS &amp; SUBSIDIES
        </h3>
        <h2 class="drama mb-1 md:-mt-3 md:mb-3 text-5xl md:text-8xl overflow-hidden font-medium text-right text-black">
          singapore <strong>SMEs</strong>
        </h2>
        <p class="pb-10 text-right text-black lg:max-w-[720px] text-base md:text-lg !leading-snug text-pretty">
